...
/**
 * draw() 메소드에 keyEventManager.update() 호출
 *
 * keyPressed() 메소드에 keyEventManager.setKeyPress(key),
 * keyEventManager.setKeyPress(keyCode) 호출
 *
 * keyReleased() 메소드에 keyEventManager.setKeyRelease(key),
 * keyEventManager.setKeyRelease(keyCode) 호출
 */
