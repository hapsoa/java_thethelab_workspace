...
public abstract class View {
    ...
    public Vector2 position;      // View의 위치 좌표
    public Vector2 size;          // View의 너비와 높이
    ...
    public View(PApplet pApplet,int shape,  float posX, float posY,
    ...
    public View(PApplet pApplet, int shape) {
        this.pApplet = pApplet;
        this.shape = shape;
