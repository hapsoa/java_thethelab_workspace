...
//        Manager.CollisionManager.Vector2 rectPos = rect.position;
...
//        Manager.CollisionManager.Vector2 rectVector = rect.position;
        float rectPosX = rect.position.x - rect.size.x/2;
        float rectPosY = rect.position.y - rect.size.y/2;
...
//        Manager.CollisionManager.Vector2 rect1pos = rect1.position;
...
//        Manager.CollisionManager.Vector2 rect2pos = rect2.position;
