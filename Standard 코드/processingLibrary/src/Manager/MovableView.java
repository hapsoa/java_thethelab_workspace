...
//    Manager.CollisionManager.Vector2 velocity;
    protected float speed;
    protected Vector2 direction;
    private boolean isKeyPressed;

    public MovableView(PApplet pApplet,int shape, float posX, float posY,
    ...
    public MovableView(PApplet pApplet, int shape) {
        super(pApplet, shape);
        this.direction = new Vector2(0,0);
        this.speed = 0;
    }
    ...
    public void update() {
        ...
        if (pApplet.keyPressed) {
            if (onKeyPressedListener != null)
                onKeyPressedListener.onKeyPress(!isKeyPressed);
            isKeyPressed = true;
        }
    ...
    public interface OnKeyPressedListener {
        void onKeyPress(boolean isFirst);
    }
...
//    public Manager.CollisionManager.Vector2 getVelocity() {
//        return velocity;
//    }
