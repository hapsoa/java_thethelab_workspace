...
public abstract class View {
    ...
    protected Vector2 position;      // View의 위치 좌표
    protected Vector2 size;          // View의 너비와 높이
    ...
    protected View(PApplet pApplet, int shape) {
        this.pApplet = pApplet;
        this.shape = shape;
    ...
    public void update() {
        ...
        if (isMouseCollision(this.pApplet.mouseX, this.pApplet.mouseY)) {
    ...
    abstract public boolean isMouseCollision(float mouseX, float mouseY);
