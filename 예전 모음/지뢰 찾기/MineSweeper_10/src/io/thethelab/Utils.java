...
class Utils {
    ...
    static int getPosYByIndex(int index) {
        return ((index / Constants.BLOCK_COUNT_X) * Constants.BLOCK_SIZE) + Constants.UI_HEIGHT;
    }

    static int getIndexByPos(int mouseX, int mouseY) {
        return (((mouseY-Constants.UI_HEIGHT) / Constants.BLOCK_SIZE) * Constants.BLOCK_COUNT_X) +
