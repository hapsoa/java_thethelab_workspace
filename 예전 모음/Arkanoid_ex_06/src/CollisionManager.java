public class CollisionManager implements Constants{
    ...
    public static boolean collisionRectCircleInside(
            Vector2 rectVector, Vector2 circleVector, int r){

        return rectVector.x + r < circleVector.x &&
                circleVector.x < rectVector.x + WALL_RIGHT - r &&
                rectVector.y + r < circleVector.y &&
                circleVector.y < rectVector.y + HEIGHT - r;
