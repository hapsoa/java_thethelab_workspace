    ...
    public void render() {
        ...
        if(visible) {
            ...
            if (color == BLOCK_WHITE)
                pApplet.image(blockimages.get(0),v.x + 45, v.y, BLOCK_SIZE_X, BLOCK_SIZE_Y);
            else if (color == BLOCK_ORANGE)
                pApplet.image(blockimages.get(1), v.x + 45, v.y, BLOCK_SIZE_X, BLOCK_SIZE_Y);
            else if (color == BLOCK_SKYBLUE)
                pApplet.image(blockimages.get(2), v.x + 45, v.y, BLOCK_SIZE_X, BLOCK_SIZE_Y);

            else if (color == BLOCK_GREEN)
                pApplet.image(blockimages.get(3), v.x + 45, v.y, BLOCK_SIZE_X, BLOCK_SIZE_Y);

            else if (color == BLOCK_RED)
                pApplet.image(blockimages.get(4), v.x + 45, v.y, BLOCK_SIZE_X, BLOCK_SIZE_Y);

            else if (color == BLOCK_BLUE)
                pApplet.image(blockimages.get(5), v.x + 45, v.y, BLOCK_SIZE_X, BLOCK_SIZE_Y);

            else if (color == BLOCK_PINK)
                pApplet.image(blockimages.get(6), v.x + 45, v.y, BLOCK_SIZE_X, BLOCK_SIZE_Y);

            else if (color == BLOCK_YELLOW)
                pApplet.image(blockimages.get(7), v.x + 45, v.y, BLOCK_SIZE_X, BLOCK_SIZE_Y);
            else if (color == BLOCK_HARD)
                pApplet.image(blockimages.get(8), v.x + 45, v.y, BLOCK_SIZE_X, BLOCK_SIZE_Y);
            else if (color == BLOCK_IMMORTAL)
                pApplet.image(blockimages.get(9), v.x + 45, v.y, BLOCK_SIZE_X, BLOCK_SIZE_Y);
