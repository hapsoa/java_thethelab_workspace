...
public class Item extends MovableView implements Constants {
    ...
    public void deActivateItem(Map map){
        ...
        if(item == ITEM_PLAYER){
            ...
            map.getVaus().backSizeX();
        }
        else if(item == ITEM_CLASP){
            map.getBall().setClaspState(false);
        }
        else if(item == ITEM_SLOW){
            pApplet.map.getBall().setVelocityBack();
        }
    ...
    public void activateItem(Map map){
        ...
        if(item == ITEM_PLAYER){
            ...
            map.getBall().setClaspState(true);
        }
        else if(item == ITEM_SLOW){
            pApplet.map.getBall().setVelocityDown();
        }
        else if(item == ITEM_BONUS){
